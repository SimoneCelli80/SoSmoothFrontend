  ...
  return (
    <div className="bg-gradient-to-r from-smoothWhite to-smoothB w-screen h-screen flex justify-center items-center select-none">
      <div className="grid grid-cols-12 grid-rows-8 h-full w-full gap-4 p-8"> 
        <div className="col-span-7 row-span-5 bg-smoothGrey rounded-3xl p-6 shadow-2xl flex flex-col">
        ...
        <a href="/login" className="col-span-2 row-span-1 rounded-3xl flex items-center justify-center bg-smoothGrey text-gray-200 shadow-2xl">
          <h1 className="text-2xl text-smoothWhite font-bold font-poppins">
            Login
          </h1>
        </a>

        <a href="/registration" className="col-span-2 row-span-1 rounded-3xl bg-smoothYellow rounded-5xl flex items-center justify-center shadow-2xl">
        ...
        <div className="flex items-center justify-center col-span-3 row-span-3">
          <div className="flex items-center justify-center w-4/5 h-4/5 bg-smoothYellow shadow-2xl  rounded-3xl font-poppins cursor-pointer">
